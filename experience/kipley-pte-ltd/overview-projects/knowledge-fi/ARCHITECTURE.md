...
| :--- | :--- | :--- | :--- |
| **Frontend Framework** | `next / react` | `v13.x / v18.x` | Dynamic Knowledge Graph Portal |
| **Animations & Physics** | `gsap` | `v3.x` | Interactive Node Visualization |
| **Design System** | `tailwindcss + mui` | `v3.x / v5.x` | Responsive Knowledge Base Layout |
