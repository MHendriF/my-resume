...
| :--- | :--- | :--- | :--- |
| **Backend Framework** | `laravel/framework` | `v6.x LTS` | Customer Storefront MVC Layer |
| **Client UI Framework** | `vue` | `v2.x` | Reactive Product Selection & Custom Card Builder |
| **Push Alert Gateway** | `brozot/laravel-fcm` | `v1.x` | Order Confirmation Alert Dispatcher |
