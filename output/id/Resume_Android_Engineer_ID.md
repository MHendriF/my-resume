...
- **Bahasa & Platform Inti:** Kotlin, Java, Android SDK, Android Studio, Gradle Multi-Module, Java OSGi
- **Arsitektur & Pola Desain:** Clean Architecture, MVVM (Model-View-ViewModel), Repository Pattern, Single Activity Architecture
- **Android Jetpack Components:** ViewModel, LiveData, StateFlow, Navigation Component, Room Database, WorkManager, ViewBinding / DataBinding
- **Asinkron & Jaringan:** Kotlin Coroutines, Flow, Retrofit 2, OkHttp 3, GSON, Moshi, RESTful API Integration
- **Pengujian & Optimasi APK:** JUnit, Mockito, Espresso, ProGuard/R8 Code Shrinking, Memory Profiling, Bundle Size Optimization
