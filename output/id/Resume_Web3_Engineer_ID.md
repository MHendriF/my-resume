...
- **Web3 & Ekosistem Blockchain:** Ethereum, EVM, TON Blockchain, Solidity Smart Contracts, OpenZeppelin Standards, Telegram Mini Apps (TMA)
- **Frontend Web3 & Integrasi Wallet:** Next.js 15, React 19, TypeScript, RainbowKit, Wagmi v2, Viem, Ethers.js v6, TON SDK, Web3Modal
- **Protokol & Streaming Data:** Server-Sent Events (SSE) AI Streaming, WebSockets, IPFS, The Graph, REST & GraphQL APIs
- **Smart Contract Tooling:** Hardhat, Remix, Web3.js, Etherscan API, MetaMask, Tonkeeper, Telegram Stars / USDT Payments
